            ...
            <div class="d-flex col-xl-4 col-lg-6 col-sm-6  auth-bg pt-120">
              <div class="col-xl-12 col-lg-12 col-sm-12 px-xl-2 mb-110">
                ...
                <form name="loginForm" class="m-t-5 loginforms">
                  ...
                  <a class="btn btn-primary btn-block" href="javascript:login();"id="save" ><i class="fas fa-save m-r-5" ></i>Save</a>                 
                  <a class="btn btn-danger btn-block" href="index.html"id="cancel" ><i class="fas fa-undo-alt m-r-5"></i>Cancel</a>                 
            </div>
                </form>
